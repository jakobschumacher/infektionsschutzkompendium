  ...
  return (
    <article className="datenschutz">
      ...
      <div className="content-section">
        ...
        <h3>GitHub Pages</h3>
        <p>
          Diese Website wird auf GitHub Pages gehostet. Anbieter ist die GitHub Inc., 88 Colin P. Kelly Jr. Street,
        ...
        <p>
          Die Nutzung von GitHub Pages erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Wir haben ein
      ...
      <div className="content-section">
        ...
        <p>
          Der Provider der Seiten (GitHub) erhebt und speichert automatisch Informationen in so genannten
